...
export default function LoginPage() {
  ...
  // Handle error messages from URL (e.g., from middleware redirects)
  useEffect(() => {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setError(
        err instanceof Error ? err.message : "Gagal terhubung ke Google"
      );
      setIsLoading(false);
    }
  };
    ...
    <div className="min-h-screen flex items-center justify-center bg-ivory-cream px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="bg-white rounded-xl shadow-lg p-8 text-center">
          ...
          {/* Error Display */}
          {error && (
            <div className="bg-soft-coral/20 border border-soft-coral rounded-lg p-4 mb-6">
